...
// toFixed(2)
console.log(1 / 3); // 0.333333
console.log((1 / 3).toFixed(2)); //0.33 biến thành Strinng, muốn biến thành số thì dùng parseFloat
console.log(parseFloat((1 / 3).toFixed(2)));
console.log(Math.ceil(Math.random() * 10));
//Math.max(1.3, -5, 100); -> trả ra con số lớn nhất
console.log("Max: " + Math.max(1, 2, 3));
//Math.max(1.3, -5, 100); -> trả ra con số nhỏ nhất
